...
#
# led.tcl: Tcl script for re-creating project 'led'
#
...
set files [list \
 [file normalize "${origin_dir}/srcs/led_top.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/srcs/led_top.sv"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "led_top" -objects $obj
...
set file "[file normalize "$origin_dir/constraints/led.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/led.xdc"
set file [file normalize $file]
